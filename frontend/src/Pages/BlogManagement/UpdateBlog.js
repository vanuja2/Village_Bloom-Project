...
function UpdateBlog() {
    ...
    useEffect(() => {
        const fetchBlog = async () => {
            try {
                ...
                setPreview(`http://localhost:8081/uploads/blog/${blog.imgURL}`);
            } catch (err) {
                console.error(err);
    ...
    const handleSubmit = async (e) => {
        e.preventDefault();
        if (!formData.title || !formData.description || !formData.ownerName || !formData.category) {
        ...
        try {
            const response = await axios.put(`http://localhost:8081/blog/${id}`, data, {
            ...
            alert("Failed to update blog. Please check the console for more details.");
        }
    };
            ...
            <div className='continer_full'>
                ...
                <div className='continer'>
                    <div className='continer_sub'>
                        <p className='from_topic'>Update Blog</p>
                        <form onSubmit={handleSubmit} className='data_from'>
                            ...
                            <button type="submit" className='auth_btn_fom' >Update Blog</button>
                        </form>
                    </div>
                </div>
            </div>
